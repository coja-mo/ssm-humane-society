    ...
    <>
      <section style={{ paddingTop: '120px', paddingBottom: '40px', background: 'linear-gradient(180deg, var(--blue-50) 0%, var(--bg-primary) 100%)' }}>
        <div className="container text-center">
          <span className="badge badge-blue" style={{ marginBottom: '12px', display: 'inline-block' }}>📬 Reach Out</span>
          ...
          <div className="grid-2" style={{ gap: '48px', alignItems: 'start' }}>
            <div className="reveal-left">
              <div className="card" style={{ padding: '36px' }}>
                ...
                <form onSubmit={handleSubmit}>
                  ...
                  <button type="submit" className="btn btn-primary" style={{ width: '100%', borderRadius: 'var(--radius-lg)' }}>
                    {sent ? '✅ Message Sent!' : 'Send Message 📨'}
                  </button>
                </form>
                {sent && (
                  <p style={{ color: 'var(--green-500)', textAlign: 'center', marginTop: '12px', fontSize: '0.85rem', animation: 'fadeInUp 0.4s ease' }}>
            ...
            <div className="reveal-right">
              <div style={{ display: 'grid', gap: '16px' }}>
                {[
                  { icon: '📍', title: 'Location', lines: ['962 Second Line East', 'Sault Ste. Marie, ON P6B 4K4'], color: 'var(--blue-400)' },
                  { icon: '📞', title: 'Phone & Fax', lines: ['Phone: 705-949-3573', 'Fax: 705-949-0169'], color: 'var(--green-500)' },
                  { icon: '📧', title: 'Email', lines: ['General: info@ssmhumanesociety.ca', 'Adoptions: adoptions@ssmhumanesociety.ca'], color: 'var(--rose-400)' },
                  { icon: '🕐', title: 'Hours', lines: ['Monday - Saturday: 12 PM - 5 PM', 'Sunday: Closed'], color: 'var(--blue-500)' },
                ].map((item, i) => (
